...
public record SolicitacaoUpdate(
        ...
        @NotBlank(message = "Descrição da falha é obrigatória") @Size(max = 255, message = "Descrição da falha deve ter no máximo 255 caracteres")
